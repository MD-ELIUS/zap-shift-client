...
const ParcelTrack = () => {
    ...
    const { data: trackings = [], isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            ...
            console.log('tracking id information', res.data); // backend থেকে আসা data
            return res.data;
        },
        enabled: !!trackingId, // ensure trackingId exists
        refetchOnWindowFocus: false,
    });

    if (isLoading) return <p>Loading tracking info...</p>;
    if (isError) return <p>Failed to load tracking info.</p>;
